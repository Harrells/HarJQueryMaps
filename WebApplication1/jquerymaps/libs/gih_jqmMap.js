...
/******************/
	...
	//*** JQM - MAP LOAD ***
	function jqmLoadMap() {
	    var theme = "jquerymaps/theme/gih_us.aspx";
	...
	function jqmLoadLegend() {
		$.ajax({url: "jquerymaps/info/legend.aspx", success: function(data) { $("#jqm_legend").html(data).show("blind");  } });
	}
    ...
    function jqmInfo(id) {
        $.ajax({url: "jquerymaps/info/gih_info.aspx", data: "id=" + id, success: function(data) { $("#jqm_info").html(data);  } });
    }