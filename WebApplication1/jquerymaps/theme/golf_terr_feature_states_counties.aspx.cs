...
public partial class jquerymaps_theme_golf_terr_feature_states_counties : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        //sql = "SELECT c.countryID, c.stateID, c.countyID, c.county, c.courses, c.rep AS total ";
        ...
        //        //Response.Write("<feature id=\"" + rd["countryID"].ToString() + "_" + rd["stateID"].ToString() + "_" + rd["countyID"].ToString() + "\" category=\"" + category_str + "\" label=\"" + Server.HtmlEncode(rd["county"].ToString()) + "\" popup=\"" + Convert.ToDouble(rd["total"].ToString()).ToString("##,##0") + "\" courses=\"" + Convert.ToDouble(rd["courses"].ToString()).ToString("##,##0") + "\" />\n");
        //        Response.Write("<feature id=\"" + rd["countryID"].ToString() + "_" + rd["stateID"].ToString() + "_" + rd["countyID"].ToString() + "\" category=\"" + category_str + "\" label=\"" + Server.HtmlEncode(rd["county"].ToString()) + "\" popup=\"" + Convert.ToDouble(rd["total"].ToString()).ToString("##,##0") + "\" courses=\"" + rd["courses"].ToString() + "\" salesRep=\"" + rd["rep"].ToString() + "\" />\n");
